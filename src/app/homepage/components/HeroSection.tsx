    ...
    <section ref={heroRef} className="relative min-h-screen flex items-center pt-28 pb-20 overflow-hidden bg-white noise-overlay">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-6 space-y-8">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.05] tracking-tight text-foreground">
            Tudo que sua{' '}
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
            ...
            <Link href="/products"
              className="px-6 sm:px-8 py-4 rounded-xl border border-border bg-white text-foreground font-bold text-sm hover:bg-surface transition-all hover:border-primary/30 text-center">
              Ver Catálogo
            </Link>
            <button
              disabled
              title="Catálogo online do Grupo HC — em breve"
              className="relative px-6 sm:px-8 py-4 rounded-xl border border-border bg-surface text-muted font-bold text-sm flex items-center justify-center gap-2 cursor-not-allowed opacity-75"
            >
        ...
        <div className="lg:col-span-6 relative h-[580px] hidden lg:block">
          <div className="absolute top-0 right-0 w-[58%] aspect-[4/5] rounded-4xl overflow-hidden shadow-2xl border border-border/40 z-10 animate-float">
            <AppImage src="/assets/images/hero-3.jpg" alt="Metalons" className="product-img w-full h-full object-cover" fill />
          </div>
          <div className="absolute top-[22%] left-0 w-[48%] aspect-square rounded-4xl overflow-hidden shadow-2xl border border-border/40 z-20 animate-float-delay">
            <AppImage src="/assets/images/hero-1.jpg" alt="Materiais de construção" className="product-img w-full h-full object-cover" fill />
          </div>
          <div className="absolute bottom-[-2%] left-[22%] w-[42%] aspect-[3/4] rounded-4xl overflow-hidden shadow-2xl border border-border/40 z-30 animate-float-slow">
            <AppImage src="/assets/images/hero-2.jpg" alt="Sacos de cimento" className="product-img w-full h-full object-cover" fill />
          </div>
